...
<head>
    ...
    <link rel="stylesheet" href="gifhover.js">
</head>
<body>
    <div class="banner">
        <div class="navbar">
...
-->
    <container>
        ...
        <div id="tekst">We begrijpen dat ouderen vaak extra ondersteuning
            ...
            middel va    n verschillende vormen van hulp en ondersteuning. 
    ...
    <div class="paginas">
        <div class="boxfoto"><img src="../Foto/pillen.gif" width="100%" height="60%" style="border-radius: 40px 40px 20px 20px;" >Medicijnen</div>
